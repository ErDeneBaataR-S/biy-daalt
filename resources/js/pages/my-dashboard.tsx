...
const cards = [
    {
        title: 'Assigned work',
        description:
            'See the tasks routed to you without opening the broader delivery workspace.',
        icon: CheckSquare,
        badge: 'Primary',
    },
    {
        ...
        description:
            'Track your own follow-ups and lightweight work items in a separate area.',
        icon: ListChecks,
        badge: 'Personal',
    },
    {
        title: 'Updates',
        description:
            'Review team and company updates that matter to your current work.',
        icon: BellRing,
        badge: 'Read only',
    },
];
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="space-y-6 px-4 py-6">
                <section className="space-y-3">
                    ...
                    <Heading
                        title="My Dashboard"
                        description="Your assigned work, personal tasks, and current updates in one focused employee entry point."
                    />
                </section>
                        ...
                        >
                            ...
                            <CardContent>
                                <p className="text-sm text-slate-500 dark:text-slate-400">
                                    This workspace keeps employee flow separate
                                    from planning-heavy manager tools.
                                </p>
                            </CardContent>
                        </Card>
                    ))}
